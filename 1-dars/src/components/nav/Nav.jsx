      ...
      <Container>
        <div className="nav__content">
          ...
          <ul className="nav__item">
            ...
            <li className='nav__item-icon'><a href="tel:912210623" target='_blank'><FaPhone /></a></li>
            <li className='nav__item-icon'><a href="https://github.com/mavlonoffdev06" target='_blank'><FaGithub /></a></li>
          </ul>
          <ul className='nav__item'>
