      ...
      <Container>
        <div className="about__content">
          ...
          <p className="about__content-subtitle">
            ...
            keen eye for creating engaging and responsive
            user interfaces. Proficient in HTML, CSS,
            JavaScript, and React js I thrive on turning
            design concepts into interactive and visually appealing
            web experiences. Constantly evolving with
            the latest web technologies, I aim to deliver
            seamless and intuitive interfaces that enhance
            user satisfaction. Let's build user-centric and
            dynamic websites together!
          </p>
          <div className="about__content-box">
            <div className="about__content-box-left">
              ...
              <h5><span> Phone:</span> +998 91 221 06 23</h5>
              ...
              <a href={cvFile} download="Resume">
                <DefaultButton text='Download CV'></DefaultButton>
              </a>
            </div>
